...
# XXD Panel 176｜مخطط طقسي مرسوم يدوياً بنحت ضحل
...
مخطط طقسي مرسوم يدوياً بنحت ضحل
...
- `design-only`: تعرض اللوحة الكاملة ترجمة Panel 176 التصميمية فقط، وتبقى الصورة مرجعاً غير ظاهر.
...
بعد التثبيت أعد تشغيل جلسة Agent ثم استدعِ `$xxd-panel-176`. ويمكن إضافة `--global --agent codex --yes` للتثبيت على مستوى المستخدم.

```text
/xxd-panel-176 photo.jpg --mode top-bottom --size 3:4 --text prompt --locale ar-SA
...
راجع [SKILL.md](SKILL.md) لعقد التشغيل الكامل، ومهايئ التشغيل [بالإنجليزية](references/xxd-panel-176-prompt.en.md) أو [بالصينية](references/xxd-panel-176-prompt.zh-CN.md).
